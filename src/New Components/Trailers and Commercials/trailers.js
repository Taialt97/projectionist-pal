...
class Trailers extends Component {
  ...
  openNotification = () => {
    notification.open({
      ...
      description: `The trailers were updated last at ${this.state.updated.substring(
        0,
        10
      )},
        if you want to update the trailers again upload a new trailer image. `,
      onClick: () => {
  ...
  uploadImage = () => {
    if (this.state.file) {
      const self = this;
      const url = "/trailers/images/upload";
      ...
      <div>
        <div className="row">
          ...
          <div className="col-4 pl-0">
            <h5 className="mb-0"> Movie List </h5>
            ...
            <Popconfirm
              placement="top"
              title={
                "Make sure the trailers are updated correctly before saving"
              }
              onConfirm={() => this.save()}
              okText="Save"
              cancelText="Cancel"
